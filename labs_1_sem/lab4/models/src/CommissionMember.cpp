...
void CommissionMember::printTable() const {
    ...
    cout << left;
    cout << "| " << setw(15) << this->lastName << " | " << setw(15) << this->firstName << " | " << setw(15) << this->middleName << " | " << setw(12) << this->birthYear << " | " << setw(20) << " - " << " | " << setw(15) << " - " << " | " << setw(20) << " - " << " | " << setw(30) << " - " << " | " << setw(10) << " - " << " | " << setw(20) << this->commissionName << " | " << setw(15) << this->appointmentYear << " | " << setw(15) << this->certificateNumber << " | " << setw(30) << autobiographyStr << " | " << setw(10) << this->autobiographyCount << " | " << setw(30) << " - " << " | " << setw(10) << " - " << " |" << endl;
}